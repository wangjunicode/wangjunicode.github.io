...
![image-20240123004316450](F:\000aaa\Blog\source\_posts\ILRuntime使用\image-20240123004316450.png)

主工程新建一个hotfixmanager类，加载热更程序集，再通过appdomain，load进来

再在主工程新建一个测试代码

![image-20240123004701895](F:\000aaa\Blog\source\_posts\ILRuntime使用\image-20240123004701895.png)

## 实现热更MonoBehaviour

![image-20240123004807802](F:\000aaa\Blog\source\_posts\ILRuntime使用\image-20240123004807802.png)
...
![image-20240123110229663](F:\000aaa\Blog\source\_posts\ILRuntime使用\image-20240123110229663.png)
...
![在这里插入图片描述](ILRuntime使用/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3FpYW9rZWx6,size_16,color_FFFFFF,t_70#pic_center.png)
