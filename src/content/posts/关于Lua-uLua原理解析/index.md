...
C#与lua的数据交互是基于一个Lua先进后出的虚拟栈：![image](/images/posts/关于Lua-uLua原理解析/lua-stack.png)
...
关于Lua虚拟栈入栈的具体操作做可以见下图：![image](/images/posts/关于Lua-uLua原理解析/lua-stack-push.png)
...
P/Invoke性能：![image](/images/posts/关于Lua-uLua原理解析/PInvoke-perf.png)
