...
description: "Unity最通用的资源加载方式，就三种"
tags: []
category: Unity开发
draft: false
---
...
1. `Resources`资源加载（Runtime和Editor模式）
2. `AssetBundle`资源加载（Runtime和Editor模式）
3. `AssetDataBase`资源加载（Editor模式）
...
![image-20230905115647887](/images/posts/Asset加载框架/image-20230905115647887.png)
